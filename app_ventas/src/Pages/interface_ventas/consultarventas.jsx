...
const FilaVenta = ({ventas, setEjecutarConsulta}) =>{
  ...
  return(
    <tr>
      ...
      <td><input type="text" readOnly value={infoNuevaVenta.valorventa} onchange={e=>setInfoNuevaVenta({...infoNuevaVenta, tventa: e.target.value === '' ? '0' : parseFloat(infoNuevaVenta.precio) * parseFloat(infoNuevaVenta.unidades)})}/></td>
